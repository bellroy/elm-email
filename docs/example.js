...
var author$project$Email$parseLocalPart = elm$parser$Parser$getChompedString(
	A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(_Utils_Tuple0),
		elm$parser$Parser$chompWhile(
...
var author$project$Email$fromString = function (string) {
	var _n0 = A2(elm$parser$Parser$run, author$project$Email$parseEmail, string);
	if (_n0.$ === 'Ok') {
		var result = _n0.a;
		return result;
	} else {
...
var author$project$Example$OnUserInputEmail = function (a) {
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Example$OnUserInputEmail),
