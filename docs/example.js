...
var $author$project$Main$OnUserInputEmail = function (a) {
	return {$: 'OnUserInputEmail', a: a};
};
...
var $author$project$Email$parseDomain = A2(
...
var $author$project$Email$parseLocalPart = A2(
	$elm$parser$Parser$andThen,
	function (localPart) {
		return (A2($elm$core$String$startsWith, '.', localPart) || (A2($elm$core$String$endsWith, '.', localPart) || (!_Utils_eq(
			...
			_List_Nil)))) ? $elm$parser$Parser$problem('localPart can\'t start or end with a dot, nor can there be double dots') : ((!_Utils_eq(
			$elm$core$String$trim(localPart),
			localPart)) ? $elm$parser$Parser$problem('localPart can\'t be wrapped with whitespace') : $elm$parser$Parser$succeed(localPart));
	},
	$elm$parser$Parser$getChompedString(
		A2(
			$elm$parser$Parser$ignorer,
...
var $author$project$Email$parseTld = A2(
	$elm$parser$Parser$andThen,
	function (a) {
...
var $author$project$Email$parseEmail = function () {
	var split = F2(
		...
		A2(
			...
			A2(
				...
				A2(
					...
					$author$project$Email$parseLocalPart),
				A2(
					$elm$parser$Parser$ignorer,
					A2(
						split,
						...
						$author$project$Email$parseLocalPart),
					$elm$parser$Parser$symbol('@'))),
			$author$project$Email$parseDomain),
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				split,
				_Utils_chr('.'),
				$author$project$Email$parseTld),
...
var $author$project$Email$fromString = function (string) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Email$parseEmail, string);
	if (_v0.$ === 'Ok') {
		var result = _v0.a;
		return result;
	} else {
...
var $author$project$Main$view = function (_v0) {
	...
	var email = $author$project$Email$fromString(userInput);
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$name('userInput'),
								...
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'is-invalid',
										($elm$core$String$length(userInput) > 1) && (!isValid)),
										_Utils_Tuple2(
										'is-valid',
										($elm$core$String$length(userInput) > 1) && isValid)
									])),
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Events$onInput($author$project$Main$OnUserInputEmail),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Email.fromString: String -> Email')
							]))
					])),
				function () {
				if (email.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Just ('),
										$elm$html$Html$text(
										$elm$core$Debug$toString(emailRecord)),
										$elm$html$Html$text(')')
									]))
							]));
				}
